    ...
    return (
        <div>
            ...
            <div className='bg-[#000000] w-full h-9 flex items-center justify-between px-2 sm:px-8'>
                ...
                <p className='md:w-5 h-5 text-white ml-40 flex justify-center items-center'>X</p>
            </div>

            {/* Navebar */}

            <div className='md:mx-28 flex justify-between items-center mt-6'>
                ...
                {/* Search Bar */}
                <div className='hidden md:flex items-center bg-[#F0F0F0] w-xl h-12 rounded-xl gap-2'>
